...
from openprompt.data_utils.text_classification_dataset import AgnewsProcessor, ImdbProcessor
import torch
...
dataset = {}
# dataset['train'] = AgnewsProcessor().get_train_examples("/workspace/project/OpenPrompt/datasets/TextClassification/agnews")
# dataset['test'] = AgnewsProcessor().get_test_examples("/workspace/project/OpenPrompt/datasets/TextClassification/agnews")

dataset['train'] = ImdbProcessor().get_train_examples("/workspace/project/OpenPrompt/datasets/TextClassification/imdb")
dataset['test'] = ImdbProcessor().get_test_examples("/workspace/project/OpenPrompt/datasets/TextClassification/imdb")
...
mytemplate = ManualTemplate(tokenizer=tokenizer).from_file("/workspace/project/OpenPrompt/scripts/TextClassification/agnews/manual_template.txt", choice=0)
...
myverbalizer = KnowledgeableVerbalizer(tokenizer, num_classes=4).from_file("/workspace/project/OpenPrompt/scripts/TextClassification/agnews/knowledgeable_verbalizer.txt")
# or
