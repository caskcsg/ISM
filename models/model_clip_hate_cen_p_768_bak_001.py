...
from models.rsd import RepresentationSubspaceDistance
...
class ALBEF(nn.Module):
    def __init__(self,                 
        ...
        # self.rsd = RepresentationSubspaceDistance()
        self.cmd = CMD()
    ...
    def forward(self, image, text, targets, alpha=0, train=True):
        ...
        align_loss = self.cmd(image_features, text_features)
        #print(align_loss)
        ##########
        ...
        output['loss'] = self.cross_entropy_loss(logits, targets.float()) + 0.001 * align_loss
