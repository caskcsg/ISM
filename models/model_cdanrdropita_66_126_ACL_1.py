    ...
    def forward(self, image, text, targets, alpha=0, train=True):
        ...
        if train:
            ...
            if self.distill:                
                ...
                loss_fc = (1-alpha)*F.cross_entropy(head_hateful, targets) - alpha*torch.sum(
                    F.log_softmax(head_hateful, dim=1)*F.softmax(head_hateful_m, dim=1),dim=1).mean()
                ...
                loss_fc = F.cross_entropy(head_hateful, targets)                
