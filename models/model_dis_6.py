...
class ALBEF(nn.Module):
    def __init__(self,                 
        ...
        ###
        # self.dis_H = Latent_Bert()   
        # self.dis_T = Latent_Bert() 
    ...
    def forward(self, image, text, targets, alpha=0, train=True):
        ...
        if train:
            ...
            h, t = image_embeds.chunk(2, 0)

            image_embed = image_hidden_state[5][:,0,:]
            ...
            hateful_i, hateful_t = self.dis_H(h, h_t)
            twitter_i, twitter_t = self.dis_T(t, t_t)
