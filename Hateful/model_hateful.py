...
class ALBEF(nn.Module):
    ...
    def private_graph(self, private_image_embeds, private_output):
        ...
        return private_graph_embedding
    ...
    def forward(self, image, text, targets, alpha=0, train=True):
        ...
        if train:
            ...
            private_graph_embedding = self.private_graph(image_embeds, output.hidden_states[7])

            # utt_private_t, utt_private_v, utt_shared_t, utt_shared_v = self.shared_private(output.hidden_states[6], image_embeds) 
            ...
            if self.distill:                
                ...
                pre = self.proj(torch.cat((output.last_hidden_state[:,0,:], private_graph_embedding[:,0,:]), dim=1))
